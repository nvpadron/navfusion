...
void UI::ui_usage(void)
{
	fprintf(stderr, 
		"*******************************************\n"
		"*                 NAVFUSION               *\n"
		"*  SENSOR FUSION: GNSS + INERTIAL SENSORS *\n"
		...
		"  -I *   Input CSV file. NOTE: must be comma separated, not Excel type. The program expects a CSV file with decimals represented with dots: \"0.1,0.5,...\".\n"
		"  -O *   Output directory\n"
		...
		"  -h     Fix height value in meters if not part of index CSV. Default is 100.\n"
		"  -R     CSV Column for ROLL. If not entered, it is calculated from accelerometer Y and Z.\n"
		"  -P     CSV Column for PITCH. If not entered, it is calculated from accelerometer X and Z.\n"
		...
		"         Subtraction happens in Platform frame (input frame). Default is 1x3 0s.\n"
		"  -p     3x3 Platform-to-Body rotation matrix. Enter as 1x9 array, the program will reshape. Enter as \"a,b,c,...,h,i\"\n"
		...
		"  -m     Set to 1 to perform mechanization of velocity in local LTP plane, set to 0 to do in body frame.  Default is 0.\n"
	    ...
	    "         and then continue with Euler derivatives. Set to 0 to use entered/calculated all the time, no euler derivatives used. Default is 1.\n"
		"  -t     Correlation time in seconds to be used in State Transition Matrix 1st order Markov processes for accelerometer and gyrometer drift. Default is 1.\n"
